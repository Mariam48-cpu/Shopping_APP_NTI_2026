...
// import 'package:shopping_app/feature/account/presentation/view/widget/text_field.dart';
...
//                   context: context,
//                   title: "Error",
//                   description: state.messageError ?? "An error occurred",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: double.infinity,
                        child: CustomButton(
                          txt: state is AccountUpdateLoading
                              ? "Updating..."
                              : "Submit",
                          width: 343,
                          height: 48,
                          ...
                          borderColor: const Color(0xff121212),
                          txtColor: Colors.white,
                          fun: state is AccountUpdateLoading
                              ? () {}
                              : () {
                                  if (_formKey.currentState!.validate()) {
                                    context.read<AccountCubit>().intent(
